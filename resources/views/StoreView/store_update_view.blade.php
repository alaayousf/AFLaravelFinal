...
@section('content')
 ...
 <h1 style="text-align: center;color:yellow">update Store</h1>


<!-- naem of store -->
<form  style="padding:20px;text-align: center;" class="col-auto my-1" enctype="multipart/form-data" action="{{URL('store/update')}}" method="POST">
...
<!-- submit button  -->
 <button style="background-color: yellow" type="submit" class="btn btn-primary">upade store </button>
